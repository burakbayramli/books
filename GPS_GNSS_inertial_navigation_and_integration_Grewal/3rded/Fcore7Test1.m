...
%
% SCHULER-CORIOIS TEST: INITIAL NORTH POS ERR OF 100 m
%
clear all;
close all;
...
disp('INS STATIONARY');
disp(['INITIAL ',num2str(xi0(2)),' m NORTH POSITION ERROR']);
minutes = hours*60;
seconds = minutes*60;
for k=1:Dt:seconds,
    xi   = Phi*xi;
...
title([num2str(xi0(2)),' m N POS'],'FontWeight','bold','FontSize',12);
...
subplot(2,2,4),plot(t/3600/Dt,he*1000,'k-',t/3600,N,'k--','LineWidth',1.5);
