...
%
% SCHULER-CORIOIS TEST: INITIAL EAST VELOCITY OF 1 m/s
%
clear all;
close all;
...
disp('INS STATIONARY');
disp(['INITIAL ',num2str(xi0(3)),' m/s EAST VELOCITY ERROR']);
minutes = hours*60;
seconds = minutes*60;
for k=1:Dt:seconds,
    xi   = Phi*xi;
...
title([num2str(xi0(3)),' m/s E VEL'],'FontWeight','bold','FontSize',12);
