...
%
% SCHULER-CORIOIS TEST: INITIAL NORTH TILT
%
clear all;
close all;
...
disp('INS STATIONARY');
disp(['INITIAL ',num2str(xi0(6)),' RADIAN NORTH-AXIS TILT ERROR']);
minutes = hours*60;
seconds = minutes*60;
for k=1:Dt:seconds,
    xi   = Phi*xi;
...
title([num2str(xi0(6)*1e6),' \mu RAD N TILT'],'FontWeight','bold','FontSize',12);
