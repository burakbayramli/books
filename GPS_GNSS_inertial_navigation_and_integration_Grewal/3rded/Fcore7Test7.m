...
%
% SCHULER-CORIOIS TEST: INITIAL HEADING ERR OF 1 MILLIRDIAN
%
clear all;
close all;
...
disp('INS STATIONARY');
disp(['INITIAL ',num2str(xi0(7)),' RADIAN HEADING ERROR']);
minutes = hours*60;
seconds = minutes*60;
for k=1:Dt:seconds,
    xi   = Phi*xi;
...
title([num2str(xi0(7)*1e6),' \mu RAD HEADING'],'FontWeight','bold','FontSize',12);
