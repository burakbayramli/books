...
%
% SCHULER-CORIOIS TEST: INITIAL EAST TILT
%
clear all;
close all;
...
disp('INS STATIONARY');
disp(['INITIAL ',num2str(xi0(5)),' RADIAN EAST-AXIS TILT ERROR']);
minutes = hours*60;
seconds = minutes*60;
for k=1:Dt:seconds,
    xi   = Phi*xi;
...
title([num2str(xi0(5)*1e6),' \mu RAD E TILT'],'FontWeight','bold','FontSize',12);
