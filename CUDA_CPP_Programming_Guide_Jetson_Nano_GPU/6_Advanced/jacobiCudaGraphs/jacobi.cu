                    ...
                    double *x_new, cudaStream_t stream)
{
    ...
    checkCudaErrors(cudaGraphAddKernelNode(&jacobiKernelNode, graph, nodeDependencies.data(), nodeDependencies.size(), &NodeParams0));
    ...
    {
        checkCudaErrors(cudaGraphExecKernelNodeSetParams(graphExec, jacobiKernelNode,
