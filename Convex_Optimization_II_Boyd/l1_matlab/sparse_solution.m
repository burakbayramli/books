...
set(gca, 'FontSize',18);
plot(1:NUM_RUNS,nnzs,[1 NUM_RUNS],[nnzs(1) nnzs(1)],'--','LineWidth',1.5);
axis([1 NUM_RUNS 0 n])
xlabel('iter'), ylabel('nnz');
legend('log heuristic','l1 heuristic','Location','SouthEast')
print -depsc sparse_solution 
