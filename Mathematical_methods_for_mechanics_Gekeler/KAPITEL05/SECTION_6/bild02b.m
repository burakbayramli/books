...
switch example
case 3, load daten3b Y U0 Parmeter
      NIVEAUS = [-0.06,-0.04,-0.02, 0.02,0.04,0.06];
case 4, load daten4b Y U0 Parmeter
      NIVEAUS = [-0.06,-0.04,-0.02, 0.02,0.04,0.06];
case 5, load daten5b Y U0 Parmeter
      NIVEAUS = [-0.06,-0.04,-0.02, 0.02,0.04,0.06];
case 6, load daten6b Y U0 Parmeter
      NIVEAUS = [-0.06,-0.04,-0.02, 0.02,0.04,0.06];
case 7, load daten7b Y U0 Parmeter
      NIVEAUS = [-0.06,-0.04,-0.02, 0.02,0.04,0.06];
case 8, load daten8b Y U0 Parmeter
      NIVEAUS = [-0.06,-0.04,-0.02, 0.02,0.04,0.06];
end
