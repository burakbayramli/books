...
% Example 5: random data
% B = identity, P, Q symmetric, not necessarily pos. definite
...
case 5 , % random data  
   load datentst P Q; c = 0; SCALE = 1; B = eye(2);
end
clf
[X,RES] = fig0501aux(P,Q); X, RES  
save daten_quad B P Q X c SCALE
if nr ~= 5
   LX = size(X,1);
