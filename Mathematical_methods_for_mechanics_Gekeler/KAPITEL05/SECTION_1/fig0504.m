function fig0504
% Figure 5.4,  Cusp Katastrophe, Projektion
% z^3 + y*z + x = 0
...
text(0.4,-0.5,0,'1 solution','fontsize',22)
text(-0.8,-0.5,0,'1 solution','fontsize',22)
text(-0.2,-1.4,0.2,'3 solutions','fontsize',22)
