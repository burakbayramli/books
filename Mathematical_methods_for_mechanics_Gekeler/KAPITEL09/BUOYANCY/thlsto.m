function [SE,ME,CE,DE,SE_LIN,ecode,BE_L,BE_Q] = thlsto(X,Y)
...
if DET > 0
 ...
 %  ML =  DET*S5/24  %mass matrix for linear elements not used 
   BE_L  = DET*S6_L/6; % load vector of linear elements
   BE_Q =  DET*SB/6;   % load vector for quadratic elements
else ecode = 1, DET, return    
end
