function [RDU,RDV,RDT,RDP,FU,FV,FT,RDZ,RCZ,RCT] = bsp01h_1(p,e,p1,parmeter)
...
RDU3 = [e(1,I),e(8,I); zeros(1,2*LI)];   % right closed, left open 
RDV3 = RDU3;

I = find(e(5,:) == 5); LI = length(I);   % boundary segment 5 (above)
RDU5 = [e(1,I),e(2,I(LI)),e(8,I);zeros(1,2*LI+1)]; % right closed, left closed 
RDV5 = RDU5;
...
RDT = [RDT1, RDT2, RDT3, RDT5, RDT6, RDT7];
