function [RDU,RDV,RDP,FU,FV,RDZ,RCZ] = bsp09h(p,e,p1)
...
RDZ7 = [e(1,I), e(8,I); zeros(1,LI),zeros(1,LI)];
I  = find(e(5,:) == 8); LI = length(I); % Randsegment 8
RDZ8 = [e(1,I),e(8,I); zeros(1,LI),zeros(1,LI)];
I  = find(e(5,:) == 9); LI = length(I); % Randsegment 9
RDZ9 = [e(1,I),e(8,I); zeros(1,LI),zeros(1,LI)];
I  = find(e(5,:) == 14); LI = length(I); % Randsegment 14
RDZ14 = [e(1,I),e(8,I); zeros(1,LI),zeros(1,LI)];
I  = find(e(5,:) == 19); LI = length(I); % Randsegment 19
RDZ19 = [e(1,I),e(8,I); zeros(1,LI),zeros(1,LI)];
I  = find(e(5,:) == 24); LI = length(I); % Randsegment 24
RDZ24 = [e(1,I),e(8,I); zeros(1,LI),zeros(1,LI)];
I  = find(e(5,:) == 29); LI = length(I); % Randsegment 29
RDZ29 = [e(1,I),e(8,I); zeros(1,LI),zeros(1,LI)];
I  = find(e(5,:) == 34); LI = length(I); % Randsegment 34
RDZ34 = [e(1,I),e(8,I); zeros(1,LI),zeros(1,LI)];
I  = find(e(5,:) == 39); LI = length(I); % Randsegment 39
RDZ39 = [e(1,I),e(2,I(LI)),e(8,I); zeros(1,LI+1),zeros(1,LI)];
I  = find(e(5,:) == 44); LI = length(I); % Randsegment 44
RDZ44 = [e(1,I),e(2,I(LI)),e(8,I); zeros(1,LI+1),zeros(1,LI)];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
I  = find(e(5,:) == 43); LI = length(I); % Randsegment 43
RDZ43 = [e(1,I),e(8,I); 0.36*ones(1,2*LI)];
I  = find(e(5,:) == 38); LI = length(I); % Randsegment 38
RDZ38 = [e(1,I),e(8,I); 0.36*ones(1,2*LI)];
I  = find(e(5,:) == 33); LI = length(I); % Randsegment 33
RDZ33 = [e(1,I),e(8,I); 0.36*ones(1,2*LI)];
I  = find(e(5,:) == 28); LI = length(I); % Randsegment 28
RDZ28 = [e(1,I),e(8,I); 0.36*ones(1,2*LI)];
I  = find(e(5,:) == 23); LI = length(I); % Randsegment 23
RDZ23 = [e(1,I),e(8,I); 0.36*ones(1,2*LI)];
I  = find(e(5,:) == 18); LI = length(I); % Randsegment 18
RDZ18 = [e(1,I),e(8,I); 0.36*ones(1,2*LI)];
I  = find(e(5,:) == 13); LI = length(I); % Randsegment 13
RDZ13 = [e(1,I),e(8,I); 0.36*ones(1,2*LI)];
I  = find(e(5,:) == 3); LI = length(I); % Randsegment 3
RDZ3 = [e(1,I),e(8,I); 0.36*ones(1,2*LI)];
I  = find(e(5,:) == 5); LI = length(I); % Randsegment 5
RDZ5 = [e(1,I),e(8,I); 0.36*ones(1,2*LI)];
