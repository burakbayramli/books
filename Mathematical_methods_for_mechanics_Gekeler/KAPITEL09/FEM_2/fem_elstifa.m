% -- ELSTIFA.M -----------------------------------------
function [SE,ME,BE,ecode] = elstifa(X,Y,E,NU,H,P)
% --------------------------------------------------------
...
D        = FAKTOR*[1  NU  0;
                   ...
                   0  0  (1-NU)/2];
ME = [...
  626,   53,   53,   14,   -4,  -13,   14,  -13,   -4;
   53,    8,    2,   17,   -4,   -1,  -13,   -2,    3;
   53,    2,    8,  -13,    3,   -2,   17,   -1,   -4;
   14,   17,  -13,  626, -106,   53,   14,   17,   -4;
   -4,   -4,    3, -106,   20,  -10,   -4,   -4,    1;
  -13,   -1,   -2,   53,  -10,    8,   17,    5,   -4;
   14,  -13,   17,   14,   -4,   17,  626,   53, -106;
  -13,   -2,   -1,   17,   -4,    5,   53,    8,  -10;
   -4,    3,   -4,   -4,    1,   -4,  -106,  -10,   20];
SE       = zeros(9,9);
BE       = zeros(9,1);
ecode    = 0;
