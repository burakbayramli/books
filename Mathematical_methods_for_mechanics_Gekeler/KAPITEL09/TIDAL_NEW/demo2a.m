...
case 1, disp(' Channel length 160 m, Period: 200 Sec. ')
   ...
   HOURS = 1; NN = HOURS*3600/PERIOD; %number of periods (integer!)
...
case 4, disp(' Channel length 4000 m')
   ...
   HOURS = 8; NN = HOURS*3600/PERIOD; 
end
NU_E = 23; % Eddy viscosity/RHO [m^2/s]
...
[MMM,MME,INVLUMP,LUMP] = massfun(p,e,t);

MASSMATRIX1 = kron(speye(3),MMM);
...
case 1
   ...
   Parmeter = [DT,A,H,L,PERIOD,g,N,kappa,XSCALE,YSCALE,NN,NU_E];
   save daten2a p e t Parmeter FF2 Example HOURS A PERIOD
case 0
   load daten2a p e t Parmeter FF2 Example HOURS A PERIOD
   switch Example
...
for ITER = 1:MAXITER
  ...
  % [T,Y] = ode23(@rside11,tspan,X0,options,Parmeter,p,e,t,FF2,MASSMATRIX);
   ...
   [RDU,RDV,RDZ] = feval(FF2,e,TT,A,PERIOD);
