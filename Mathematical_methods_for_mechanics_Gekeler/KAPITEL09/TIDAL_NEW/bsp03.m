function [p,e,t,MESSPKT] = bsp03
% channel  cf. Petera/Nassehi
% Int. J. Num. Meth. Eng. 39(1996), 4159-4182
%
% length 3000, width 200 [m]
XSCALE =100;        % XBAI  : scale factor in X axis
YSCALE =100;        % YBAI  : scale factor in Y axis
%
p = [0, 0, 0, 1, 1, 1;
     2, 1, 0, 2, 1, 0];
...
waterdepth = 10;
p = [p;waterdepth*ones(1,size(p,2))];
MESSPKT = e2(2,1);
