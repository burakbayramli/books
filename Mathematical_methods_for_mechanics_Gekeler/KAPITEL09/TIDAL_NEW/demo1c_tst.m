...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% as demo1c.m but with Cauchy bc
...
for ITER = 1:MAXITER
 %  VN = (V*MM + 0.5*DT*rside_1(V,p,e,t,Parmeter))*INVLUMP; %good
   ...
   VN = (V*MM + 0.5*DT*rside_3(V,p,e,t,Parmeter,FF2,T))*INVLUMP; %good
 ...
 %  VN = (V*MME + 0.5*DT*rside_1(V,p,e,t,Parmeter))*INVLUMP; % fails  
  ...
  % VN = (V*MM + DT*rside_1(VN,p,e,t,Parmeter))*INVLUMP;
   ...
   VN = (V*MM + DT*rside_3(VN,p,e,t,Parmeter,FF2,T))*INVLUMP;
