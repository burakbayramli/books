function [p,e,t,waterdepth] = bsp01
...
KNOTEN = KNOTEN.';
p = KNOTEN(1:2,:); waterdepth = KNOTEN(3,:);
...
t = [t;ones(1,LT)];
%
% boundary of bay to sea
e1 = [1 2 3 4;
      2 3 4 5];
e1 = [e1;([1:4]-1)/4; [1:4]/4; 
      ones(1,4);ones(1,4);zeros(1,4)];
% boundary of bay to land
e2 = [...
   5, 12, 13, 14, 15, 16, 28, 40, 62, 70 ...
  79, 90,100,110,109,108,107,106,105,104 ...
 103,102,101, 91, 80, 71, 63, 41, 29, 17, 6;
   12, 13, 14, 15, 16, 28, 40, 62, 70, 79  ...
  90 ,100,110,109,108,107,106,105,104, 103 ...
  102,101, 91, 80, 71, 63, 41, 29, 17, 6, 1];
  LE = size(e2,2);
