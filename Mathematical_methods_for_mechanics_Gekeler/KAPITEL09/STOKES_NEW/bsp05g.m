function [x,y] = bsp05g(bs,s)
% Example after Boukir with exact solution
%   Geometry data for PDE Toolbox
%
...
% A = [X-Werte; Y-Werte];
switch segnr
case 1, A = [0  1; -0.5  -0.5];
case 2, A = [1  1; -0.5  0.5];
case 3, A = [1  0; 0.5  0.5];
case 4, A = [0  0; 0.5  -0.5];
end
N = size(A,2); L = 0; AUX = zeros(1,N); P = AUX;
for I = 1:N-1
    % approximate length of segments
