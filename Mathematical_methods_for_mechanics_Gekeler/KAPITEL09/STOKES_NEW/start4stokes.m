function [p,e,t,out_bound] = start4stokes(FF1,FF2,OPTION_MESH,REFINE,JIGGLE) 
% makes mesh for Taylor-Hood elements
% E.W. Gekeler, Release 2.03.07 
if nargin == 4, JIGGLE = 0; end
...
case 2, disp(' mesh with MATLAB TOOLBOX, fast ')
