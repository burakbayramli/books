function VN1 = flow_4(p,t,V,VN,DTT,Parmeter);
...
for I = 1:M
   ...
   % falls NU ~= 0
   %SU   = V(1,K)*DET/6 - DT24*(AUXU + sum(AUXU)) - BDT; % selective lumping
   ...
   % falls NU ~= 0
%   SV   = V(2,K)*DET/6 - DT24*(AUXV + sum(AUXV)) - CDT; % selective lumping
   % -- Z part ------------------
