...
load daten5a p e t Parmeter MAXITER Beispiel
switch Beispiel
   case 1, load daten5b MONITOR_U MONITOR_Z MAXITER
   case 2, load daten5c MONITOR_U MONITOR_Z MAXITER
   case 3, load daten5d MONITOR_U MONITOR_Z MAXITER
end
...
case 1, disp(' Plot fuer unteren Rand des Kanals ')
   ...
   for K = 1:MAXITER
      T = DT*K;
      ITER_SEKUNDEN = [K,T]
      %plot(XX,MONITOR_Z(J,K),'b','linewidth',2), hold on
