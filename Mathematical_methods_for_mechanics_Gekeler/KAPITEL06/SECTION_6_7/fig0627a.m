...
J = find(D_PHI < 6); TT2 = TT2(J); D_PHI = D_PHI(J);
...
text(2,4,'d\phi/dt','fontsize',20)
text(1.4,4.5,'V_{eff}','fontsize',20)
text(0.1,2.2,'0','fontsize',20)
text(2.9,2.3,'\pi','fontsize',20)
text(2.9,5.3,'E','fontsize',20)
