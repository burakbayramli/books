% Figure1.16, Skizze zu  Projektor: Stetigkeit + Kontraktion
clc, clf
CC = 30;
PHI1 = 2*pi*(90-CC)/360;
PHI2 = 2*pi*(90+CC)/360;
...
axis equal 
grid on
text(3.5,12.25,'v','fontsize',40)
text(-4.1,12.25,'w','fontsize',40)
text(1.6,8.6,'Pv','fontsize',40)
text(-2.6,8.6,'Pw','fontsize',40)
axis off
