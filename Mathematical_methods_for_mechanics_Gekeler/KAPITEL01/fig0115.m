function fig0115
% Figure 1.15, Projection theorem
...
axis equal
grid on
text(-2.3,-0.25,'u','fontsize',40)
text(-1.3,1,'v','fontsize',40)
text(-4.2,-0.25,'w','fontsize',40)
text(-3.5,1,'\phi \geq \pi/2','fontsize',40)
%title('Zu Lemma 33(a)','fontsize',40)
% -- Rahmen
RX = [-4.4,-1,-1,-4.4,-4.4];
