...
{\bf Vorbereitung.} Berechne
\beqn \ba{.}{ll}
D = [d_j]_{1 \leq j \leq n-m} := B^{-1}N, & x := B^{-1}b, \\
...
Setze
\beqn \ba{.}{ll}
D = [q_{k \, l}]_{1 \leq k \leq m\,,\,1 \leq l \leq n-m}, & x =  [q_{k,
...
&
\ba{.}{l} \mbox{hei\ss t Simplextableau, $x$ enth\"alt die aktuellen
Werte der}\\
