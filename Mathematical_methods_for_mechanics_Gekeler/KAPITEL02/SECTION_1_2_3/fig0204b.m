function fig0204b
% Figure 2.4, Hermite basis polynomial H_1i for n = 3
clf
...
plot(X,H10,'k','linewidth',2), hold on
plot(X,H11,'b','linewidth',2), hold on
plot(X,H12,'r','linewidth',2), hold on
plot(X,H13,'g','linewidth',2), hold on
rr = 0.04;
circle(0,1,rr,'w')
circle(1,1,rr,'w')
circle(2,1,rr,'w')
