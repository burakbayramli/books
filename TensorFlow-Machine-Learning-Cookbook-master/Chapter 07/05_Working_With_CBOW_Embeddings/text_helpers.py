...
def load_movie_data():
    save_folder_name = '/home/burak/Documents/general/cnn-text-classification-tf-master/data'
...
#    with codecs.open(pos_file, 'r', encoding='utf-8') as f:
    with codecs.open(pos_file, 'r', encoding='latin-1') as f:
        for line in f:
    ...
    with codecs.open(neg_file, 'r', encoding='latin-1') as f:
        for line in f:
