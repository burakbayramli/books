"""
   Usage: run airfoil_M0x8_1x25deg_sim
...
from HLLC_SOLVER_TRI_GENERAL import *
...
# CPU time = 3.1 min for sim_time = 0.0002 
# Iplot = 100; 260 iterations to reach t = 0.0002

# CPU time = 62 min for sim_time = 0.004
# Iplot = 1000; 3741 iterations to reach t = 0.004

# CPU time = 9.05 hours for sim_time = 0.032
# Iplot = 4000; 45991 iterations to reach t = 0.032
...
solver = HLLC_TRI(CFL,pp,dd,uu,vv, \
                  ...
                  BC_forced,x1,x2,y1,y2,Iplot=4000)
