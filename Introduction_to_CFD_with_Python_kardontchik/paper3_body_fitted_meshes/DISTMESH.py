    ...
    def __call__(self,p):
        ...
        for j in range(len(p)):
            ...
            opt = fmin(Ellipse_dist_to_minimize,t0, \
                       args=(p[j],xc,yc,a,b),full_output=1)
...
# I found that sometimes the Delaunay module 'forgets' to enumerate
# isolated triangles in the generated mesh.
# A missing triangle in an otherwise complete mesh creates an artificial
# additional boundary (usually internal to the mesh)
