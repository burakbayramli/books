The program displays the Face data set.  An environment map is drawn on the
face.  Rotate the face using the F1 through F6 function keys to see how the
environment effect changes.
