...
clf;
hold off;
nodes(:,2:3)=nodes(:,2:3)+feU(:,4:5)*1000;
...
for i=1:nElements
  for j=1:nElementEdges-1
    x1=nodesOld(elements(i,j+1),2);
    y1=nodesOld(elements(i,j+1),3);
    x2=nodesOld(elements(i,j+2),2);
    y2=nodesOld(elements(i,j+2),3);
    plot([x1 x2],[y1 y2],'k:','Linewidth',2);
  end 
  x1=nodesOld(elements(i,2),2);
  y1=nodesOld(elements(i,2),3);
  plot([x1 x2],[y1 y2],'k:','Linewidth',2);
end;
