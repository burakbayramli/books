...
% using the method of lines to solve the heat equation U_t = beta*U_xx
global A b
...
s = beta/(dx^2);  % gain parameter 

% build the A matrix to march method of lines solution forward in time
...
figure(4)
mesh (t,x,U')
title ('Variation of Temperature distribution with time using Method of Lines')
xlabel ('t')
ylabel ('x')
zlabel ('U')
