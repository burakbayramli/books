function [t, y] = adamspc5(varf, a, b, y0, h)
% Performs the Adams-Bashforth-Moulton fifth order predictor-corrector
% scheme to solve an IVP.
...
for n=5:nmax
   ...
   %corrector
   y(n+1)=y(n)+h/720*(251*feval(varf, t(n+1),y(n+1))+646*feval(varf, t(n),y(n))...
       -264*feval(varf, t(n-1),y(n-1))+106*feval(varf, t(n-2),y(n-2))-19*feval(varf, t(n-3),y(n-3)));
end
