...
```
    ...
    <matplotlib.image.AxesImage at 0x7f449e25c550>
...
```
    ...
    total time 0.13847200000000015 s
    time per timestep = 0.013847200000000014 s
    mom assembly time 0.061861999999999195 s
    solver time 0.07661000000000096 s
    solver fraction = 56.0 %
...
```
    ...
    <matplotlib.colorbar.Colorbar at 0x7f449beeec18>
...
```
    ...
    <matplotlib.contour.QuadContourSet at 0x7f449be7d390>
...
```
    ...
    <matplotlib.streamplot.StreamplotSet at 0x7f449b9b2a58>
