"""
   Usage: run tri_mesh
   (eliminates the two points closest to the NACA tail)
"""
# Save generated mesh in file:
filename = 'tri_mesh_40deg' # include any other useful info, for ex: 'tri_mesh_40deg'
...
h0 = 1.4*hh0
qmin = 0.68
# angle = 40, run with qmin = 0.68
# stopped at iter # 35 with:qmin=0.72,min_angle=31, 1867 tri; 3 ears, corrected
