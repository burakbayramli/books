"""
   Usage: run case17
      Case 17 in Table 4.3, Liska_Wendroff_02.
...
# -----------------------------------------------------------
#       case 17: INITIAL CONDITIONS IN EACH QUADRANT
#                        (p,d,u,v)
# -----------------------------------------------------------
upper_left = [1.0, 2.0, 0.0, -0.3]
lower_left = [0.4, 1.0625, 0.0, 0.2145]
upper_right = [1.0, 1.0, 0.0, -0.4]
lower_right = [0.4, 0.5197, 0.0, -1.1259]
...
# b) CPU time of 8.5 hours,  # iterations = 989
# c) use Iplot = 300
...
# (and, say, Iplot = 30, to avoid screen cluttering)
