"""
   Usage: run case15
      Case 15 in Table 4.3, Liska_Wendroff_02.
...
# -----------------------------------------------------------
#       case 15: INITIAL CONDITIONS IN EACH QUADRANT
#                        (p,d,u,v)
# -----------------------------------------------------------
upper_left = [0.4, 0.5197, -0.6259, -0.3]
lower_left = [0.4, 0.8, 0.1, -0.3]
upper_right = [1.0, 1.0, 0.1, -0.3]
lower_right = [0.4, 0.5313, 0.1, 0.4276]
...
# b) CPU time of 4.3 hours,  # iterations = 520
# c) use Iplot = 200
