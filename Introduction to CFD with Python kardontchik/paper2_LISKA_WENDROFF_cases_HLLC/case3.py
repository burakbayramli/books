...
# b) CPU time: about 8 hours (see other cases, for more exact number)
# c) use Iplot = 200

# To determine the right size [a,b]x[a,b] of the computational domain
# use a larger granularity, for ex, h0 = 0.03

# Using h0 = 0.03, a computational domain [-0.75,1.75]x[-0.75,1.75] 
# a) it generates about 2,200 triangles in [0,1]x[0,1] (and about 13,500
# triangles in the computational domain)
# b) CPU time: 17 min, number of iterations = 313
# c) use Iplot = 50 (to avoid screen cluttering with too many figures)

# for fast initial testing (to get used to the program) use, for
# example, h0 = 0.1
