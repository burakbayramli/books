"""
   Usage: run case12
      Case 12 in Table 4.3, Liska_Wendroff_02.
...
# -----------------------------------------------------------
#       case 12: INITIAL CONDITIONS IN EACH QUADRANT
#                        (p,d,u,v)
# -----------------------------------------------------------
upper_left = [1.0, 1.0, 0.7276, 0.0]
lower_left = [1.0, 0.8, 0.0, 0.0]
upper_right = [0.4, 0.5313, 0.0, 0.0]
lower_right = [1.0, 1.0, 0.0, 0.7276]
...
# b) CPU time of 6.5 hours,  # iterations = 784
# c) use Iplot = 200
