"""
   Usage: run case3_oblique
      Case 3 in Table 4.3, Liska_Wendroff_02 at any angle in [-89,+89] degrees
...
x0 = 0.5; y0 = 0.5
# rotation angle in degrees with respect to the +x axis (ccw - positive, cw - negative)
angle = 30.0  # in degrees in [-89,+89]
...
dx = 0.04 # 0.01
dy = 0.04 # 0.01
# for Figure 8 in paper "Performance of simple spatial-discretization ..."
# use:
x1 = 0.0; x2 = 1.0
y1 = 0.0; y2 = 1.0
# for Figure 9 in paper "Performance of simple spatial-discretization ..."
# use:
#x1 = -0.5; x2 = 1.5
#y1 = -0.5; y2 = 1.5
...
p_ic,d_ic,u_ic,v_ic = ic_phys_2D_angle(upper_left,lower_left,upper_right,lower_right,x,y,x0,y0,angle)
...
wa = ENO_HLLC_SOLVER_2D(CFL,x,y,dx,dy,p_ic,d_ic,u_ic,v_ic,interp,Iplot=20)
dd,uu,vv,pp,ee = wa(t)
