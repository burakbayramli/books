...
class RK_ENO_HLLC_SOLVER_1D:
    ...
    def calc_eno_hllc_flux(self,u1,u2,u3,u4):
        interp = self.interp
        ...
        for i in range(2,len(u1)-3): # except in the ghost cells
            ...
            if pL < 0 or pR < 0:
                print 'negative pressure in RK_ENO_HLLC_SOLVER_1D'
                print 'pL = %g, pR = %g' % (pL,pR)
            if dL < 0 or dR < 0:
                print 'negative density in RK_ENO_HLLC_SOLVER_1D'
    ...
    def __call__(self,t):
        ...
        while (tn <= t):
            ...
            one_f1,one_f2,one_f3,one_f4 = self.calc_eno_hllc_flux(one_u1,one_u2,one_u3,one_u4)
            ...
            # Step III:
            # given the new u[i]'s, reconstruct the new u[i+1/2]'s and calculate the new fluxes
            two_f1,two_f2,two_f3,two_f4 = self.calc_eno_hllc_flux(two_u1,two_u2,two_u3,two_u4)
