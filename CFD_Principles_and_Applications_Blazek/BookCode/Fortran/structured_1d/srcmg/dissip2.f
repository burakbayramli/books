      SUBROUTINE Dissip2( imax,ib2,beta,vol,cv,p,dt,dp,d,diss )

C *****************************************************************************
C
C  Computes scalar artificial dissipation (JST-scheme), but only the second
C  differences. This dissipation is intended for use on coarse grids.
C
C *****************************************************************************
C
