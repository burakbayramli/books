...
ContourValues = linspace(0.1,3.1,25);   
                          % Set to either a scalar, for automatic contours or
                          % a vector of contour levels.

%---------------------------------

% for scatter plot (PlotType==4):
UserMap1d = 1;   % map1d.m specifies that scatter plot should be q vs. x
ScatterStyle = setplotstyle('b+','r+','g+');
