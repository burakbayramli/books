function results = lr_f_sar(y,x,W,N)
% PURPOSE : Computes the LR statistic to test the presence of spatial autocorrelation
% under the form of an endogenous spatial lag in a fixed effects panel data
% model. (only individual effects, no time effects).
...
% W : (N x N) weight matrix for spatial autoregressive component 
...
% Computation of the unconstrained model (SAR Estimation)
info.lflag=0;
res1=sar_panel_FE_LY(y,x,W,N,info);
liku=res1.lik;
