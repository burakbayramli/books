...
r = D*dt/dx^2
tic
[u1,err1,x1,t1] = buggy_heat_eul_neu(t_0,t_f,D,L,M,N);
rtime(1)=toc;
...
r = D*dt/dx^2
tic
[u2,err2,x2,t2] = buggy_heat_eul_neu(t_0,t_f,D,L,M,N);
rtime(2) = toc;
...
r = D*dt/dx^2
tic
[u3,err3,x3,t3] = buggy_heat_eul_neu(t_0,t_f,D,L,M,N);
rtime(3)=toc;
...
r = D*dt/dx^2
tic
[u4,err4,x4,t4] = buggy_heat_eul_neu(t_0,t_f,D,L,M,N);
rtime(4)=toc;
...
r = D*dt/dx^2
tic
[u5,err5,x5,t5] = buggy_heat_eul_neu(t_0,t_f,D,L,M,N);
rtime(5)=toc;
...
% r = D*dt/dx^2
% tic
% [u6,err6,x6,t6] = buggy_heat_eul_neu(t_0,t_f,D,L,M,N);
% rtime(6)=toc;
