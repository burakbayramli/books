% [u,x,t,kk,amp] = burgers2a(u0,D,t_0,t_f,M,N)
%
...
% and the linear term explicitly.  t_0 is the initial time, t_f is the
...
% of 2.)
%
function [u,x,t,kk,amp] = burgers2a(u0,D,t_0,t_f,M,N)
...
% 
%     hat{u^{n+1}}_k  = hat{u^n}_k - D k^2 dt hat{u^{n+1}}_k - dt hat{g^n}_k 
% 
