...
[u1,x,t1,kk,amp] = alt_final_PDE(u0,t_0,t_f,M,N);
M = 2*M;
[u2,x,t2,kk,amp] = alt_final_PDE(u0,t_0,t_f,M,N);
M = 2*M;
[u3,x,t3,kk,amp] = alt_final_PDE(u0,t_0,t_f,M,N);
M = 2*M;
[u4,x,t4,kk,amp] = alt_final_PDE(u0,t_0,t_f,M,N);
...
k = 3;
u0 = ubar + eps*cos(k*x);
[u1,x,t,kk,amp] = alt_final_PDE(u0,t_0,t_f,M,N);
for j=1:M+1
...
eps = eps/2;
u0 = ubar + eps*cos(k*x);
[u2,x,t,kk,amp] = alt_final_PDE(u0,t_0,t_f,M,N);
for j=1:M+1
...
eps = eps/2;
u0 = ubar + eps*cos(k*x);
[u3,x,t,kk,amp] = alt_final_PDE(u0,t_0,t_f,M,N);
for j=1:M+1
...
eps = eps/2;
u0 = ubar + eps*cos(k*x);
[u4,x,t,kk,amp] = alt_final_PDE(u0,t_0,t_f,M,N);
for j=1:M+1
...
eps = eps/2;
u0 = ubar + eps*cos(k*x);
[u5,x,t,kk,amp] = alt_final_PDE(u0,t_0,t_f,M,N);
for j=1:M+1
...
eps = eps/2;
u0 = ubar + eps*cos(k*x);
[u6,x,t,kk,amp] = alt_final_PDE(u0,t_0,t_f,M,N);
for j=1:M+1
