...
# bind <Return> to comp_s after comp_s is defined...

# do not tie a variable to the label, use configure in comp_s:
s_label = Label(rframe, width=12)

# do not pack as we need to define compute button first, and since
# that button refers to comp_s, this procedure must be declared
# first(this not a problem when realizing the GUI as class object)
