...
CPU time of ./make_module_1.sh: 3.5 seconds on hpl-lapx30 i686, Linux
...
exceptions.ValueError a is not of type 'Float'
exceptions.ValueError NumPy array is 1-dimensional; expected 2 dimensions
exceptions.TypeError Not a callable object
CPU time of ../../Grid2Deff.py: 0.3 seconds on hpl-lapx30 i686, Linux
