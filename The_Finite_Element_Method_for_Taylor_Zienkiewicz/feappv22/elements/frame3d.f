...
c     Three dimensional frame element
...
c       Inertial and body force effects
...
c       Lumped mass computation
        ...
        if(d(7).eq.0.0d0) then
          ...
          do i = 1,3
            r(i,1)         = r(i,1) - dn*(ul(i,1,5) + d(77)*ul(i,1,4))
     &                     + b(i)
            r(i,2)         = r(i,2) - dn*(ul(i,2,5) + d(77)*ul(i,2,4))
     &                     + b(i)
...
c       Compute member force if necessary
