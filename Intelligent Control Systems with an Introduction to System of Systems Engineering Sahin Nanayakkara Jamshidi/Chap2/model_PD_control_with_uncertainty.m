...
% The parameters of the controller. These parameters are based on estimated
% link parameters with a 10% error.
...
% Kp = [2 0;0 2];Kv = [0.5 0;0 0.5];
% Kp = [5 0;0 2];Kv = [0.5 0;0 0.5];
Kp = [5 0;0 2];Kv = [1 0;0 1];
...
for i = 1:Time_span
    ...
    tau = tau + Kp*[thetad(i,1) - state(1);thetad(i,2) - state(2)] + Kv*[theta_dot_d(i,1) - state(3);theta_dot_d(i,2) - state(4)];
