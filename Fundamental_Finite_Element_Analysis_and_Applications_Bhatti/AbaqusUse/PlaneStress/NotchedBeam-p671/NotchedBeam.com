...
args = {
    ...
    'importer':OFF,
    'includes':[],
    'indir':'/tmp_mnt/nfs/server00/local/vol02/user5/mabhatti/WileyVol1/abaqus/Chap1/stress',
    'input':'NotchedBeam',
    'job':'NotchedBeam',
    ...
    'outdir':'/tmp_mnt/nfs/server00/local/vol02/user5/mabhatti/WileyVol1/abaqus/Chap1/stress',
    'outputKeywords':ON,
    'paid_up':OFF,
    'parameterized':OFF,
...
env = { 
    ...
    'KRB5CCNAME':'FILE:/tmp/krb5cc_2175_17230',
    'LANG':'C',
    'LINES':'26',
    ...
    'PWD':'/tmp_mnt/nfs/server00/local/vol02/user5/mabhatti/WileyVol1/abaqus/Chap1/stress',
    ...
    'SESSIONTYPE':'dt',
    'SESSION_MANAGER':'local/l-ecn018.engr.uiowa.edu:/var/spool/sockets/ICE/17290,tcp/l-ecn018.engr.uiowa.edu:59383',
    'SESSION_SVR':'l-ecn018.engr.uiowa.edu',
    'SHELL':'/bin/csh',
