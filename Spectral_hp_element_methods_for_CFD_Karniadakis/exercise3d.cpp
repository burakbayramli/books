...
g++ -c polylib.c
g++ -c exercise3d.cpp 
g++ -o exercise3d exercise3d.o polylib.o -llapack -g2c
*/
...
void *assem(int Mdim, int np, int P, double *z, double *w, double *phi1, double *phi2, double **M, double *f, double *p, double *assem);
...
main()
{
  ...
  double *z,*w,*p,*f,*phi1,*phi2,*u_H,*u_D,*bc,**M,sum=0;
  ...
  assem(Mdim, np, P, z, w, phi1, phi2, M, f, p, u_D);
...
void *assem(int Mdim, int np, int P, double *z, double *w, double *phi1, double *phi2, double **M, double *f, double *p, double *u_D)
{
  for(int i=0;i<Mdim;i++){
    ...
    f[i] = integr(np, phi1, p, w) - integr(np, phi1, u_D, w);
  }
}
