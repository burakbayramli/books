////////////////////////////////////////////////////////////////////////////////////////////////////
// 2D DSMC solver for steady-state problems, Template 06
//--------------------------------------------------------------------------------------------------
// The purpose of this template is to implement input parameters, initial condistions, and
// free stream boundary conditions for the problem of flow past a thin wind at an angle of attack
//
// This version of the code can be used in order to verify that the model correctly reproduce the
// homogeneous equilibrium free stream in the whole domain, since the boundary conditions at
// the wing surface are not taken into account yet.
//--------------------------------------------------------------------------------------------------
