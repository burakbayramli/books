...
case 0
   ...
   for alpha=a1:b1:c1
    ...
    case 25   %%Aeroelaststuff
%                     g=9.82;         %Gravity
%                     n=2.5;          %Loadfactor
%                     wingno=1;       %First wing only so far
%                     
%                     %load('aircraft\structure\test_structure_3.mat')
%                     
...
%                     disp(strcat(strcat('at an alpha of :',num2str(alpha)),' [rad]'));
% 
%                     %state.alpha=alpha*0.70;
%                   
%                     
%                     
%                     [results_1,lattice,convergence,FEMresult]=aeroelast2(wingno,geo,state,structure,mesh);
