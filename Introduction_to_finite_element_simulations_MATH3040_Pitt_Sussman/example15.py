...
# Plot eigenfunction
plot(u, title="First eigenvector")

# How many eigenpairs were found?
print eigensolver.get_number_converged(), " converged eigenpairs"

prm=eigensolver.parameters
info(prm,True)

# Extract another eigenpair
r, c, rx, cx = eigensolver.get_eigenpair(199)

print "another eigenvalue: ", r
...
# Plot eigenfunction
plot(u, title="200-th eigenvector")
