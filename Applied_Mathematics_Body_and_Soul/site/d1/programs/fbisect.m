function x = fbisect(f, int, tol)
% fbisect - bisection algorithm for the scalar equation f(x) = 0
% 
%   Syntax: 
%           x = fbisect(f, int, tol)
%   Arguments: 
...
%   Description:
%           The program fbisect uses the bisection algorithm to 
...
%          Then:
%
%          x = fbisect('f', [1,4], 1e-7)   computes pi to 7 decimals
%
%----------------------------------------------------------------------
