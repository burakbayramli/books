...
def line(x, slope, x0, y0):
    """ return a line with a given slow passing through (x0, y0) """
...
def main():
    ...
    print("derivative at x = {}".format(coarse[3]))
    ...
    leg = plt.legend(loc=2, labelspacing=0.1, frameon=False, fontsize="small")
