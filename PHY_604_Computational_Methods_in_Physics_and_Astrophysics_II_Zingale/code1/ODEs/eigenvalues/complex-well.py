...
# note: the next eigenvalue by the analytic expression is E = 6, but
# this is the top of the potential well, so this is not a bound state


# try some pairs of eigenvalue guesses
for E_old, E_new in [(-2.9, -2.95), (-2.3, -2.5), (4.9, 4.95)]:
