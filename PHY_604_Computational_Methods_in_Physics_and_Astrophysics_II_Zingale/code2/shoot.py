...
def rk4(y1_0, y2_0, rhs, xl = 0.0, xr = 1.0, n=100):
    """
    R-K 4 integration: y1_0 and y2_0 are y1(0) and y2(0) rhs is the
...
plt.scatter(x, y1_old, label="initial guess", marker="x",c=colors[0])
...
while dy > eps:
    ...
    dfdeta = ( (y1_right_true - y1_old[npts-1]) -
               (y1_right_true - y1[npts-1]) ) / (y2_m1 - y2_0)
