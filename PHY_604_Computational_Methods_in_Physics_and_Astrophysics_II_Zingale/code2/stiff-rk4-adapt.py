...
# plot the orbit
plt.plot(h.t, h.y, label="4th order adaptive RK", color="g")
plt.plot(h.t, analytic(h.t), label="analytic", color="b")

plt.savefig("stiff-rk4-adaptive.png")
...
plt.savefig("stiff-dt-rk4-adaptive.png")
