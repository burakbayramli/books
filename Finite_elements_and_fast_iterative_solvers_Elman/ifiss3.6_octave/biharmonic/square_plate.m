%SQUARE_PLATE solve clamped plate problem in square domain
%   IFISS scriptfile: DJS; 1 August 2021.
...
%% set up matrices
qmethod=3;
tic,[A,Q,f] = femq3_plate(xy,ev); dtoc=toc;
fprintf('system setup in %8.3e seconds\n',dtoc)
% alternative code for constant load
