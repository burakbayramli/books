%NAVIER_TESTPROBLEM_PC sets up Examples 8.1 to 8.4
...
elseif sn==3,
   lid_model=default('cavity type leaky\tight\regularised 1\2\3 (regularised)',3); 
   if lid_model ==3,
...
elseif sn==6,
system('copy .\stokes_flow\test_problems\symstep_flow.m .\stokes_flow\specific_flow.m');
system('copy .\stokes_flow\test_problems\symstep_bc.m .\stokes_flow\stream_bc.m');
