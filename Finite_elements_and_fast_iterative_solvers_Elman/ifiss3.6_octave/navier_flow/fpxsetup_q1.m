function [a,f] = fpxsetup_q1(xy,xyp,mv,mp,flowsol,viscosity,domain,map)
...
fprintf('computing Q1 pressure preconditioning matrices... \n')
%
...
%
%% Dirichlet conditions for Ap at outflow boundary: mimic finite differences
   xmax = max(xy(:,1));
