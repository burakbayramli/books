...
% the signal
[yin,fs]=wavread('bat1.wav'); %read wav file
yo=yin(3900:8500); %select the part with sound
tiv=1/fs;
...
imagesc(t,f,log10(abs(WD)),[-6 0]); axis xy;
xlabel('seconds'); ylabel('Hz'); 
title('Filtered Wigner distrib. of the Bat signal');
