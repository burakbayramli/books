...
args = {
    ...
    'importer':OFF,
    'includes':[],
    'indir':'/tmp_mnt/nfs/server00/local/vol02/user5/mabhatti/WileyVol1/abaqus/Chap1/tower',
    'input':'tower',
    'job':'tower',
    ...
    'outdir':'/tmp_mnt/nfs/server00/local/vol02/user5/mabhatti/WileyVol1/abaqus/Chap1/tower',
    'outputKeywords':ON,
    'paid_up':OFF,
    'parameterized':OFF,
...
env = { 
    ...
    'PWD':'/tmp_mnt/nfs/server00/local/vol02/user5/mabhatti/WileyVol1/abaqus/Chap1/tower',
