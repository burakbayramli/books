...
%%   G1 continuity connection of Bézier surfaces
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
clear all; close all;
...
%% moving control points to ensure
%% the G1 continuity connection
for k2=1:np4
...
fs=18;title('G1 continuity connection','FontSize',fs);
hold off
