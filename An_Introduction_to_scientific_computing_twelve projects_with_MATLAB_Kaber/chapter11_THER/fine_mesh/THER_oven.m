...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
    function [T0,Tres,Numtri,Coorpt]=THER_oven(Refdir,Valdir,Conduc,Pres); 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
%%   function [T0,Tres,Numtri,Coorpt]=THER_oven(Refdir,Valdir,Conduc,Pres)
%%
...
%%
%-> Read the mesh file
    [Nbpt,Nbtri,Coorpt,Refpt,Numtri,Reftri]=THER_readmesh; 
%-> Plot the mesh
...
%   Plot matrix A 
    ...
    spy(Aelim); 
    title('Matrix A (fine mesh)','FontSize',fs);
%-> Solution of the first problem (no warming)
    T0=Aelim\belim; 
    fprintf('\n Homegeneous temperature field') 
%-> Solution of all problems (with warming) 
